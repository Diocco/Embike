...
(0, express_validator_1.check)('correo').custom(verificaciones_1.correoUnico), (0, express_validator_1.check)('rol').custom(verificaciones_1.esRolValido), middlewares_1.validarCampos, // Devuelve un error al usuario si algun check fallo
usuarios_1.agregarUsuario); // Agrega un nuevo usuario a la base de datos
router.put('/:id', //Actualiza un usuario
(0, express_validator_1.check)('id').custom(verificaciones_1.usuarioExiste), // Verifica existencia y validez del id
middlewares_1.validarJWT, middlewares_1.validarIDJWT, (0, express_validator_1.check)('rol').optional().custom(verificaciones_1.esRolValido), // Si se manda un rol verifica que sea valido
...
middlewares_1.validarJWT, (0, middlewares_1.validarRolJWT)('admin'), (0, express_validator_1.check)('id').custom(verificaciones_1.usuarioExiste), // Verifica existencia y validez del id
middlewares_1.validarCampos, // Devuelve un error al usuario si algun check fallo
